    ...
    <div className="privacy-policy">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Laudebugs.
          </p>
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Laudebugs, accessible from
          https://laudebugs.me/
        </li>{" "}
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          https://laudebugs.me/laudebugs.me/#/privacy-policy
        </li>
      </ul>
    </div>
  </>
